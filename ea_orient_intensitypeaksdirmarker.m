...
% Peaks are constrained to be at 360°/noPeaks angles to each other.
% Function runs a noPeaks * (360°/noPeaks) array over the intensity-profile and 
% finds the angle at which the sum of all peaks is highest.
%
% USAGE:
%
